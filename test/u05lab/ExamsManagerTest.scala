...
import u05lab.code.{ExamResultFactoryImpl, Kind}


class ExamsManagerTest {
  private val erf = new ExamResultFactoryImpl()
//  private val em = new ExamsManagerImpl()
...
//    assertEquals(em.getAllStudentsFromCall("gennaio"),new HashSet<>(List("rossi","bianchi","verdi","neri")))
//    assertEquals(em.getAllStudentsFromCall("marzo"),new HashSet<>(List("rossi","bianchi","viola")))
//
